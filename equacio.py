...
#printamos el resultado #inoneline convertiendo directamente los valores de float a string i passando los argumentos al print()
print('x1={0:.3f} y x2={0:.3f}'.format(sol1,sol2)) 
